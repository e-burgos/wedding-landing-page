          ...
          <Grid className={classes.sectionContent} container direction='row' spacing={2}>
            <Grid container justifyContent='center' alignItems='center'>
              <Link
                ...
                aria-hidden='true'>
                <span>
                  <img src={footerSection.icons.gif} alt='contactUs' className={classes.logo} />
                </span>
              </Link>
              <Grid container direction='column' className={classes.secondColumn}>
                ...
                <Grid item className={'w-p-100'}>
                  <p className={classes.copyright}>©{currentYear} - Develop by Esteban Burgos - All Rights Reserved.</p>
                </Grid>
              </Grid>
            </Grid>
          </Grid>

          ...
          <Grid className={classes.sectionContent} container direction='row' spacing={2}>
            <Grid container justifyContent='center' alignItems='center'>
              <Link
                ...
                aria-hidden='true'>
                <span>
                  <img src={footerSection.icons.gif} alt='wedding' className={classes.logo} />
                </span>
              </Link>
              <Grid container direction='column' className={classes.secondColumn}>
                ...
                <Grid item className={'w-p-100'}>
                  <p className={classes.copyright}>©{currentYear} - All Rights Reserved.</p>
                  <p className={`${classes.copyright} ${classes.develop}`}>Develop by Esteban Burgos</p>
                </Grid>
              </Grid>
            </Grid>
          </Grid>
